...
const UpdateTeamMember = ({ teamMember, onSuccess }: { teamMember: TeamMemberProp; onSuccess?: () => void }) => {
    ...
    const [photoPreview, setPhotoPreview] = useState(teamMember.photo ?? "");
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await axios.patch(`/api/admin/teammember/${teamMember._id}`, formData, { withCredentials: true })
    ...
    return (
        <DialogContent className="sm:max-w-md">
            <DialogHeader>
                <DialogTitle className="font-inter">Update Team Member</DialogTitle>
                <DialogDescription>
                    Edit this team member's details below.
                </DialogDescription>
            </DialogHeader>
