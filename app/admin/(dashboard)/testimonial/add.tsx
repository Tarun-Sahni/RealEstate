...
const initialForm = { name: "", designation: "", message: "" }

const AddTestimonial = ({ onSuccess }: { onSuccess?: () => void }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const response = await axios.post("/api/admin/testimonial", formData, { withCredentials: true })
    ...
    return (
        <DialogContent className="sm:max-w-md">
            <DialogHeader>
                <DialogTitle className="font-inter">Add Testimonial</DialogTitle>
                <DialogDescription>
                    Add a client testimonial to show on the website.
                </DialogDescription>
            </DialogHeader>
